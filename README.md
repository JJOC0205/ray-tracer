...
This project follows the [_Ray Tracing in One Weekend_](https://raytracing.github.io/books/RayTracingInOneWeekend.html) book by Peter Shirley, Trevor David Black, and Steve Hollasch. All credit for the base souce code belongs to them. Some small syntactic changes were made, but beyond that all credit belongs to them for the base project.
